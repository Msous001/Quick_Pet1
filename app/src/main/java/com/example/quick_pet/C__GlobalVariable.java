...
//    }
    ...
    public static List<C__CurrentPet> getCurrentPets() {
        return currentPets;
    }

    public static void setCurrentPets(List<C__CurrentPet> currentPets) {
        C__GlobalVariable.currentPets = currentPets;
    }
}
